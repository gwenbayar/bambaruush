...
abstract class $StickerCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String lessonId, String imageAssetPath, String nameEn});
}
...
class _$StickerImpl implements _Sticker {
  ...
  @override
  String toString() {
    return 'Sticker(id: $id, lessonId: $lessonId, imageAssetPath: $imageAssetPath, nameEn: $nameEn)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, lessonId, imageAssetPath, nameEn);
...
abstract class _Sticker implements Sticker {
  const factory _Sticker(
      ...
      required final String nameEn}) = _$StickerImpl;
